...
namespace ElasticSearch.Linq.Request.Criteria
{
    ...
    public class RangeCriteria : ICriteria
    {
        ...
        public RangeCriteria(string field, MemberInfo member, IEnumerable<RangeSpecificationCriteria> specifications)
        {
            ...
            Argument.CheckNotNull("specifications", specifications);
    ...
    public class RangeSpecificationCriteria : ICriteria
    {
        ...
        {
            Argument.CheckIsDefinedEnum("comparison", comparison);
            Argument.CheckNotNull("value", value);
