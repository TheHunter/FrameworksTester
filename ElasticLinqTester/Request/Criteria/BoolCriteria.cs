...
namespace ElasticSearch.Linq.Request.Criteria
{
    ...
    /// </summary>
    public class BoolCriteria : ICriteria
    {
        ...
        /// </summary>
        public IReadOnlyCollection<ICriteria> Must
        {
            get { return must; }
        }
        ...
        /// </summary>
        public IReadOnlyCollection<ICriteria> Should
        {
            get { return should; }
        }
        ...
        /// </summary>
        public IReadOnlyCollection<ICriteria> MustNot
        {
            get { return mustNot; }
        }
    }
