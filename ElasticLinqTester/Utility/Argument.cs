...
namespace ElasticSearch.Linq.Utility
{
    ...
    static class Argument
    {
        ...
        public static void CheckNotNull(string argumentName, object value)
        {
            if (value == null)
        ...
        public static void CheckPositive(string argumentName, TimeSpan value)
        {
        ...
        public static void CheckNotEmpty(string argumentName, string value)
        {
        ...
        public static void CheckIsAssignableFrom<T>(string argumentName, Type type)
        {
        ...
        public static void CheckIsDefinedEnum<TEnum>(string argumentName, TEnum value) where TEnum : struct
        {
        ...
        public static void CheckNotEmpty(string argumentName, ICollection values)
        {
